...
0. Follow every project setup steps: `Every Project README.md Setup Section`
0. Make sure the tests pass on your machine: `Every Project README.md Test Section`
